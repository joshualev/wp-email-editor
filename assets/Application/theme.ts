 ...
 *
 * Defines the application's visual design system using MUI's theming API.
 * This theme provides consistent styling across all UI components.
 *
 * Brand Color System:
 * - BRAND_NAVY: Primary dark color for headers and emphasis
 * - BRAND_BLUE: Primary action color (buttons, links)
 * - BRAND_GREEN: Success states and positive feedback
 * - BRAND_RED: Error states and destructive actions
 * - BRAND_YELLOW: Warning highlights and accents
 * - BRAND_PURPLE: Secondary accent color
 * - BRAND_BROWN: Tertiary accent color
 *
 * Custom Palette Extensions:
 * - cadet: 5-step gray scale for backgrounds and borders
 * - highlight: 5-step yellow scale for selection states
 * - brand: Direct access to brand colors
 *
 * Typography:
 * - Uses system font stack for optimal performance
 * - Monospace stack for code/JSON display
 *
 * @module Application/theme
 * @see {@link https://mui.com/material-ui/customization/theming/}
 */
import { alpha, createTheme, darken, lighten } from '@mui/material/styles';

/** Primary navy brand color - Used for headers and emphasis */
